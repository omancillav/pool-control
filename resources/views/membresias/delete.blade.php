        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="deleteModalLabel{{ $membresia->id }}">Eliminar Membresía</h4>
                ...
                <form action="{{ route('membresias.destroy', $membresia->id) }}" method="POST">
                    ...
                    <div class="modal-body">
                        <p>¿Estás seguro de eliminar la membresía del usuario <strong>{{ $membresia->usuario->name ?? 'Sin nombre' }} {{ $membresia->usuario->last_name ?? '' }}</strong>?</p>
                    </div>
