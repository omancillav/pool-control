        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title"><i class="fas fa-credit-card"></i> Información de la Clase y Pago</h3>
                </div>
                <div class="card-body">
                    <!-- Información de la clase -->
                    <div class="row mb-4">
                        <div class="col-md-6">
                            <h5><strong>Detalles de la Clase</strong></h5>
                            <table class="table table-borderless">
                                ...
                                <tr>
                                    ...
                                    <td>{{ $clase->lugares_disponibles }} de {{ $clase->lugares }}</td>
                                </tr>
                            </table>
                        </div>
                        <div class="col-md-6">
                            ...
                            <div class="alert alert-info">
                                <h4><i class="fas fa-dollar-sign"></i> Total a Pagar</h4>
                                <h2 class="text-center">${{ number_format($clase->precio, 2) }} MXN</h2>
                            </div>
                        </div>
                    </div>

                    <!-- Formulario de pago -->
                    <form method="POST" action="{{ route('pagos.procesar', $clase->id) }}">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-check">
                                ...
                                <label class="form-check-label" for="pago_online">
                                    ...
                                    <small class="d-block text-muted">El pago se procesará inmediatamente y tu reservación será confirmada.</small>
                                </label>
                            </div>
                            <div class="form-check mt-2">
                                ...
                                <label class="form-check-label" for="pago_fisico">
                                    <i class="fas fa-money-bill text-warning"></i> <strong>Pago Físico el Día de la Clase</strong>
                                    <small class="d-block text-muted">Puedes pagar en efectivo o tarjeta el día de la clase. Tu lugar quedará reservado.</small>
                                </label>
                            </div>
                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="card bg-light">
                                            <div class="card-body text-center">
                                                ...
                                                <small class="d-block"><strong>Procesamiento Inmediato</strong></small>
                                                <small class="text-muted">Confirmación instantánea</small>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="notas" name="notas" rows="3" placeholder="Alguna nota especial sobre tu reservación..."></textarea>
                        </div>

                        <div class="form-group text-center">
                            <button type="submit" class="btn btn-success btn-lg">
                                <i class="fas fa-lock"></i> Procesar Pago y Confirmar Reservación
                            </button>
                            <a href="{{ route('reservaciones.index') }}" class="btn btn-secondary btn-lg ml-2">
